...
public class NoticeBoardPagingVO {
	...
	private int onePageCount=5; //한 페이지당 표시할 페이지 수
	private int rownumEnd; //페이지 마지막 레코드
	private int lastPageRecord = 10; //마지막 페이지 레코드 수

	public NoticeBoardPagingVO(int onePageRecord, int currentPage, int totalRecord) {
