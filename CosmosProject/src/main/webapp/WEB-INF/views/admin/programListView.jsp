...
<script>
	function delChk(){
		if(confirm("정말로 해당 프로그램을 삭제하시겠습니까?")){
			location.href="/web/admin/programDelete?num=${vo.p_num}";
		}
	}
</script>
</head>
...
<nav role='navigation'>
	...
	<div class="contentAdmin" style="height: 950px;">
		<ul class="nav nav-pills nav-justified">
	  	...
	  	<div class="admin">
			...
			<div class="adminListView">
				...
				<ul class="viewbtnUl">
					<li>
						<a href="/web/admin/programEdit?num=${vo.p_num}">수정</a>
