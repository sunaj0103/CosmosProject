...
<nav role='navigation'>
	...
	<div class="contentAdmin" style="height: 1200px;">
		<ul class="nav nav-pills nav-justified">
			<li class="active"><a href="/web/admin">프로그램 정보 입력</a></li>
		...
		<div class="admin" style="height: 1100px;">
			<h2 class="formTitle">프로그램 정보 입력</h2>
			<p class="formDesc">프로그램 정보를 입력하세요.</p>
			<div class="adminInput">
				<form id="programInputFrm" name="programInputFrm" method="post" action="/web/admin/programWrite">
					<ul class="inputUl ulSize">
						<li>
							<label for="title">프로그램명</label>
						</li>
						<li>
							<input type="text" id="title" name="title" class="nInput"/><br/>
						</li>
					</ul>
					<ul class="inputUl ulSizeText">
						...
						<li><textarea id="description" name="description" class="textInput" rows="8" cols="50"></textarea></li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							<input type="text" id="recommend" name="recommend" class="nInput"/><br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							<input type="text" id="total_num_of_applicants" name="total_num_of_applicants" class="mInput"/>명<br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							<input type="text" id="child" name="child" class="mInput"/>원<br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							<input type="text" id="teenager" class="mInput"/>원<br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							<input type="text" id="adult" class="mInput"/>원<br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							최소 인원: <input type="text" id="discount_min" name="discount_min" class="mInput"/>명, &nbsp;
							할인율: <input type="text" id="discount_rate" name="discount_rate" class="mInput"/>%
						</li>
					</ul>
					<input type="button" id="adminInputBtn" class="adminInputBtn" value="작성 완료"/>
				</form>
			</div>
		</div>
	</div>
