...
$(function(){
    ...
    $("#programTimeWriteBtn").click(function(){
		if($("#start_date").val() == ""){
...
<nav role='navigation'>
	...
	<div class="contentAdmin">
		<ul class="nav nav-pills nav-justified">
	    	...
	    	<li class="active"><a href="/web/admin/programTimeWrite">프로그램 시간 입력</a></li>
	  	...
	  	<div class="admin">
			<h2 class="formTitle">프로그램 시간 정보 입력</h2>
			<p class="formDesc">프로그램 시간 정보를 입력하세요.</p>
			<div class="adminInput">
				<form name="programTimeWriteFrm" method="post" action="/web/admin/programTimeWriteOk">
					<ul class="inputUl ulSize">
						<li>
							<label for="title">프로그램명</label>
						</li>
						<li>
							<select name="p_num" class="lSelect">
								<optgroup label="프로그램명">
									<c:forEach var="vo" items="${p_list}">
										<option value="${vo.p_num}">${vo.title}</option>
									</c:forEach>
								</optgroup>
							</select>						
						</li>
					...
					<ul class="inputUl ulSize">
						...
						<li>
							<input type="text" id="start_date" name="start_date" class="nInput"/><br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							<input type="text" id="start_time" name="start_time" class="nInput"/><br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li>
							<input type="text" id="end_time" name="end_time" class="nInput"/><br/>
						</li>
					</ul>
					<ul class="inputUl ulSize">
						<li>
						...
						<li class="genderRadio">
							<input type="radio" id="statY" class="radio-custom" name="status" value="Y" checked>
							<span>예약 진행</span>
	          				<input type="radio" id="statN" class="radio-custom" name="status" value="N">
	          				<span>마감</span>
						</li>
					</ul>
					<input type="button" id="programTimeWriteBtn" class="adminInputBtn" value="작성 완료"/>
				</form>
			</div>
		</div>
	</div>
